...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnapEditor : Editor
    {
        ...
        private void HeaderInformation()
        {
            ...
            GUILayout.Label("Version: 1.1.5", new GUIStyle() { fontSize = 14, alignment = TextAnchor.MiddleCenter });
        ...
        {
            EditorGUILayout.IntSlider(startingPanel, 0, simpleScrollSnap.Content.childCount - 1, new GUIContent("Starting Panel", "The number of the panel that will be displayed first, based on a 0-indexed array."));
        }
        ...
        private void Pagination()
        {
            ...
            if (simpleScrollSnap.pagination != null)
            {
                ...
                if (numberOfToggles != simpleScrollSnap.Content.childCount)
                {
                    EditorGUILayout.HelpBox("The number of toggles should be equivalent to the number of panels. There are currently " + numberOfToggles + " toggles and " + simpleScrollSnap.Content.childCount + " panels.", MessageType.Warning);
                }
                EditorGUI.indentLevel--;
            }
        }
